...
!function(t){"use strict";jQuery(document).ready(function(){t(".login-to-register").on("click",function(e){e.preventDefault(),t(this).toggleClass("login-status"),t(this).hasClass("login-status")?(t(this).text(t(this).attr("data-login")),t(this).parents(".register-content-box").find(".block-login").hide(),t(this).parents(".register-content-box").find(".block-register").show()):(t(this).text(t(this).attr("data-register")),t(this).parents(".register-content-box").find(".block-login").show(),t(this).parents(".register-content-box").find(".block-register").hide())}),t(".main-nav").length>0&&t(".main-nav").each(function(){var e=t(this).offset().left-t(this).parents(".container").offset().left-15;t(this).find(".has-mega-menu > .sub-menu").css("margin-left","-"+e+"px")}),t(".fruit-list-cat").length>0&&t(".fruit-list-cat").each(function(){t(this).find(".item-fruit-cat1").on("mouseover",function(){t(this).parents(".fruit-list-cat").find(".item-fruit-cat1").removeClass("item-center"),t(this).addClass("item-center")}),t(this).on("mouseout",function(){t(this).find(".item-fruit-cat1").removeClass("item-center"),t(this).find(".item-active").addClass("item-center")})}),t(".range-filter").length>0&&t(".range-filter").each(function(){t(this).find(".slider-range").slider({range:!0,min:0,max:800,values:[50,545],slide:function(e,n){t(this).parents(".range-filter").find(".amount").html("<span>Price: $"+n.values[0]+"</span><span> - $"+n.values[1]+"</span>")}}),t(this).find(".amount").html("<span>Price: $"+t(this).find(".slider-range").slider("values",0)+"</span><span> - $"+t(this).find(".slider-range").slider("values",1)+"</span>")}),t(".detail-qty").each(function(){var e=parseInt(t(this).find(".qty-val").text(),10);t(this).find(".qty-up").on("click",function(n){n.preventDefault(),e+=1,t(".qty-val").text(e)}),t(this).find(".qty-down").on("click",function(n){n.preventDefault(),(e-=1)>1?t(".qty-val").text(e):(e=1,t(".qty-val").text(e))})}),t(".toggle-mobile-menu").on("click",function(e){e.preventDefault(),t(this).parents(".main-nav").toggleClass("active")}),t(".custom-scroll").length>0&&t(".custom-scroll").each(function(){t(this).mCustomScrollbar({scrollButtons:{enable:!0}})}),t(".detail-gallery").length>0&&t(".detail-gallery").each(function(){var e=t(this),n=e.find(".carousel").data();e.find(".carousel").jCarouselLite({btnNext:e.find(".next"),btnPrev:e.find(".prev"),speed:800,visible:n.visible,vertical:n.vertical}),t(".detail-gallery").find(".mid img").elevateZoom({zoomType:"inner",cursor:"crosshair",zoomWindowFadeIn:500,zoomWindowFadeOut:750}),t(this).find(".carousel a").on("click",function(e){e.preventDefault(),t(this).parents(".detail-gallery").find(".carousel a").removeClass("active"),t(this).addClass("active");var n=t(this).find("img").attr("src");t(this).parents(".detail-gallery").find(".mid img").attr("src",n),t(".zoomWindow").css("background-image",'url("'+n+'")')})}),popup_wishlist(),rep_menu(),offset_menu(),toggle_tab(),background_image(),t(".wow").length>0&&(new WOW).init(),t(".btn-video").length>0&&t(".btn-video").fancybox({openEffect:"none",closeEffect:"none",prevEffect:"none",nextEffect:"none",arrows:!1,helpers:{media:{},buttons:{}}}),t(".fancybox").length>0&&t(".fancybox").fancybox(),t(".scroll-top").on("click",function(e){e.preventDefault(),t("html, body").animate({scrollTop:0},"slow")}),t(".box-hover-dir").each(function(){t(this).hoverdir()})})}(jQuery);