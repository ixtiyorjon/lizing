window.JSMaps.maps.uzbekistan = {
    "config": {
        ...
        "defaultText": `
            <div class="areas">
                <h1 class="areas-title">Uzbekistan</h1>
                <ul>
                    <li>
                        <span class="areas-span1">Бошқарув раиси:</span>
                        <span class="areas-span2">Холмурадов Акмал Арсланович</span>
                    </li>
                    <li>
                        <span class="areas-span1">Манзил:</span>
                        <span class="areas-span2">Навоий шаҳри Ғалаба шоҳ кўчаси 176а-уй</span>
                    </li>
                    <li>
                        <span class="areas-span1">Индекс:</span>
                        <span class="areas-span2">210100</span>
                    </li>
                    <li>
                        <span class="areas-span1">Қабул кунлари:</span>
                        <span class="areas-span2">душанба-жума 08:00-11:00</span>
                    </li>
                    <li>
                        <span class="areas-span1">Телефон: </span>
                        <span class="areas-span2">(+998 71) 244-62-73</span>
                    </li>
                    <li>
                        <span class="areas-span1">Электрон почта манзили:</span>
                        <span class="areas-span2">info@agroleasing.uz</span>
                    </li>
                    <li>
                        <span class="areas-span1">Жамоат транспорти:</span>
                        <span class="areas-span2">7,11 ва 30-сонли автобуслар</span>
                    </li>
                </ul>
            </div>`
    },
    "paths": [
        {
            ...
            "color": "#00bfa5",
            "hoverColor": "#f1dbdb",
            "selectedColor": "#042a41",
            "url": "http://jsmaps.io/",
            "text": `
            <div class="areas">
                <h1 class="areas-title">Ferghana</h1>
                <ul>
                    <li>
                        <span class="areas-span1">Бошқарув раиси:</span>
                        <span class="areas-span2">Холмурадов Акмал Арсланович</span>
