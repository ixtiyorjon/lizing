...
@csrf
    <button onclick="return confirm('Вы уверены, что хотите удалить эту информацию?');" type="submit" style="background: none;border: none;color: #337ab7;padding: 0"><i class="glyphicon glyphicon-trash"></i></button>
</form>